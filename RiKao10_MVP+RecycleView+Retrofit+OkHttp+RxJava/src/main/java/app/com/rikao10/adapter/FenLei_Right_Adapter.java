package app.com.rikao10.adapter;
...
public class FenLei_Right_Adapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        //实现右边数据子条目布局适配器
        Set_FenLei_Child_Adapter childAdapter = new Set_FenLei_Child_Adapter(context,list,i,i1);
...
/*        childAdapter.setOnItemClickListener(new childAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(context, Xiang_Activity.class);
